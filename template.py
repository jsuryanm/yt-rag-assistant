...
list_of_files = [
    ...
    f"{project_name}/agents/transciptor_agent.py",
    f"{project_name}/agents/rag_agent.py",
    f"{project_name}/agents/mcp_agent.py",
    f"{project_name}/tools/__init__.py",
    f"{project_name}/tools/youtube_tools.py",
    f"{project_name}/tools/retrieval_tools.py",
    f"{project_name}/state/__init__.py",
    f"{project_name}/state/graph_state.py",
